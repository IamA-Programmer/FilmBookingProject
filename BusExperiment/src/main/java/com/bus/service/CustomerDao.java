...
//	@Cacheable(cacheNames = "history", key = "#id")
	...
	public List<MovieDetails> getAllMovie(){
		List<MovieDetails> list = (List<MovieDetails>) this.movieRepo.findAll();
		return list;
	}
	...
	public Admin adminLogin(String username,String Password) {
		Admin Check=adminrepo.findByUsernameAndPassword(username, Password);
		return Check;
	}
	
	//saving the movie details by admin
	public void saveMovies(MovieDetails moviedetails) {
